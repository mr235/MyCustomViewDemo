...
public class RemoteControlMenu extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        pts[0] = event.getRawX();
        pts[1] = event.getRawY();
        System.out.println("getRawX:" + pts[0] + " getRawY:" + pts[1] + " getX:" + event.getX() + " getY:" + event.getY());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mMapMatrix.isIdentity()) {
            ...
            mMapMatrix.postTranslate(-location[0], -location[1]);
        }
        System.out.println("mViewWidth:" + mViewWidth + " mViewHeight:" + mViewHeight);
        System.out.println(mMapMatrix);
